 ...
 */
    ...
    public:
         ...
         */
        template<typename T>
        std::vector <T> get_vector(const string &name) const;

        template<typename T>
        std::vector <T> get_vector(char name) const;
    ...
    private:
        ...
        template<typename T>
        static string to_string(const std::vector <T> &value);
        ...
        template<typename T>
        static T from_string(const string &value);

        template<typename T>
        static std::vector <T> from_string(const string &value, char delim);
 ...
 */
    ...
    public:
         ...
         */
        template<typename T>
        option &with_arg(T default_value = T());
         ...
         */
        template<typename T>
        option &with_arg_vector(const std::vector <T> &default_value = std::vector<T>());
         ...
         */
        template<typename T>
        option &with_arg_vector(const string &default_value);
...
// utility ---------------------------------------------------------------------------------
    ...
    template<>
    inline string parser::to_string<integer>() {
        return "integer";
    }

    template<>
    inline string parser::to_string<real>() {
        return "real";
    }

    template<>
    inline string parser::to_string<string>() {
        return "string";
    }

    template<>
    inline string parser::to_string<ivector>() {
        return "vector<integer>";
    }

    template<>
    inline string parser::to_string<rvector>() {
        return "vector<real>";
    }

    template<>
    inline string parser::to_string<svector>() {
...
// with_arg_vector(vector) -----------------------------------------------------------------------------------
    template<>
    inline parser::option &
    parser::option::with_arg_vector<integer>(const std::vector <integer> &default_value) {
    ...
    template<>
    inline parser::option &
    parser::option::with_arg_vector<real>(const std::vector <real> &default_value) {
        mother_.must_not_be_parsed("parser::option::with_arg_vector");
    ...
    template<>
    inline parser::option &
    parser::option::with_arg_vector<string>(const std::vector <string> &default_value) {
        mother_.must_not_be_parsed("parser::option::with_arg_vector");
...
// as ----------------------------------------------------------------------------------------
    ...
    inline integer parser::option::as<integer>() const {
        ...
        if (type_ != INTEGER)
            throw logic_error("argument type of '" + names_[0] + "' is not integer");
        return value_i_;
    }
    ...
    inline string parser::option::as<string>() const {
        ...
        if (type_ != STRING)
            throw logic_error("argument type of '" + names_[0] + "' is not string");
        return *value_s_;
    }
...
// as_vector -----------------------------------------------------------------------------------
    ...
    inline ivector parser::option::as_vector<integer>() const {
        ...
        if (type_ != IVECTOR)
            throw logic_error("argument type of '" + names_[0] + "' is not vector<integer>");
        return *value_iv_;
    }
    ...
    inline rvector parser::option::as_vector<real>() const {
        ...
        if (type_ != RVECTOR)
            throw logic_error("argument type of '" + names_[0] + "' is not vector<real>");
        return *value_rv_;
    }
    ...
    inline svector parser::option::as_vector<string>() const {
        ...
        if (type_ != SVECTOR)
            throw logic_error("argument type of '" + names_[0] + "' is not vector<string>");
        return *value_sv_;
    }
